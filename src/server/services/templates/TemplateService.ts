...
请以JSON格式返回，字段如下：
{
  ...
  "synopsis_stages": [
    "[string] 第一阶段：背景设定与人物介绍（必须约400字符，包含详细的时间地点、完整角色介绍、基调建立、伏笔埋设等）",
    "[string] 第二阶段：初始冲突与矛盾爆发（必须约400字符，包含具体冲突事件、挑战内容、各方立场、角色反应等）",
    "[string] 第三阶段：情节发展与关系复杂化（必须约400字符，包含矛盾升级过程、关系变化、角色成长、情感蓄力等）",
