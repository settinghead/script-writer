...
### 剧本格式规范（好莱坞标准）
- **场次格式**：采用标准格式 "场次编号 地点，时间，内外" （如：1-1 银行外，日，外）
- **场次限制**：每集控制在3-5个场次内，确保每个场次充分展开
- **字数要求**：每个场次不少于500-800字，保证内容饱满
- **出场标注**：每场开始必须标注本场出场人物，格式：|人物1、人物2、人物3
- **时间标注**：必须明确标注日/夜和内/外，用于拍摄通告安排
- **字幕旁白**：可使用人物(V0)格式添加内心独白或旁白
...
|王野（32岁，海市警局首席谈判专家）、林琛（35岁，特警队长）、警员若干
...
|林玥、卓旭飞、女网红、神秘粉丝(方大海)、小助理A、小助理若干、明星若干、记者若干、随从1、2、粉丝若干、环境人物

[字幕:大夏群星之夜盛典]

林玥(V0),每个人背后,都有秘密

红毯闪光灯此起彼伏，众星云集。林玥一袭白色晚礼服，优雅地走过红毯。

记者A：林玥！林玥！请问您对今晚的颁奖有什么期待？
...
在人群中，方大海戴着鸭舌帽，紧紧盯着林玥，手中握着一个神秘的包裹。
...
### 剧本制作要求
- **格式标准**：严格按照好莱坞剧本格式，场次编号-地点，时间，内外
- **场次控制**：每集限制3-5个场次，每场次500-800字以上
- **人物标注**：每场开始用"|"标注本场出场人物
- **场景描述**：简洁明了，便于拍摄执行
- **对话设计**：自然流畅，符合人物性格
- **动作指导**：清晰可执行，适合短剧节奏
...
1. **格式严格**：严格按照 "场次编号 地点，日/夜，内/外" 格式，用逗号分隔
2. **场次控制**：限制3-5个场次，每场次500-800字以上，内容饱满
3. **人物标注**：每场用"|"开头标注出场人物，便于拍摄安排
4. **开场抓人**：前30秒必须建立冲突或悬念
5. **节奏控制**：每个场景都要推进剧情，避免拖沓
6. **情感爆点**：在关键节点制造强烈的情感反应
7. **视觉呈现**：考虑移动端观看特点，动作和表情要明确
8. **连续性**：确保与前后集的衔接自然
9. **制作友好**：时间和内外景标注清晰，便于制片安排
