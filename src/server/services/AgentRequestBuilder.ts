...
2. 如果结果搜出”李成和小红在持续情感拉扯“，那可以判定男主和小红有情感关系，进一步用queryJsondocs搜索：”李成 小红“，了解历史
3. 根据历史信息，用"edit_剧本设定"工具，创建新人物，比如”小花“，给工具的instruction: “添加一个新人物，名叫小花。小花在李成被罚钱时出现，并且帮助了他，而且对李成有好感”
4. 返回给用户一个友好的消息，(humanReadableMessage)：“好的，已经添加了新人物小花，并且让小花在李成最低谷时出现，帮助了他...”
