...
export * from './types';
import { ArtifactSchemaRegistry } from './schemas/artifacts';
...
export function validateArtifactData(schemaType: TypedArtifact['schema_type'],
    schemaVersion: TypedArtifact['schema_version'], data: any): boolean {
