...
export type CurrentSection = 'ideas' | 'ideation-edit' | '故事设定' | 'chronicles' | 'episode-planning' | 'episode-content' | null;
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
            (entries) => {
                ...
                const sectionSelectors = ['#ideas', '#故事设定', '#chronicles', '#episode-planning', '#episode-synopsis'];
                ...
                allSectionData.forEach(({ id, rect, element }) => {
                    ...
                    if (intersectionRatio > 0.03 && (id === 'ideas' || id === '故事设定' || id === 'chronicles')) {
                ...
                if (!activeSection && allSectionData.length > 0) {
                    ...
                    allSectionData.forEach(({ id, rect }) => {
                        ...
                        if (intersectionRatio > 0 && (id === 'ideas' || id === '故事设定' || id === 'chronicles')) {
